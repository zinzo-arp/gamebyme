class Game {
  constructor() {
    ...
    this.erase(); // Clear the canvas initially
  }
  ...
  // Erase the canvas
  erase() {
    this.canvas.fillStyle = '#ADD8E6'; // Light blue background
    this.canvas.fillRect(0, 0, 300, 300); // Clear the entire canvas
    this.canvas.fillStyle = '#000000'; // Black text color
  }
}
